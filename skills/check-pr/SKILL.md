---
name: check-pr
description: Self-review before submitting a PR. Use when the user wants to review their changes before creating or submitting a pull request.
---
...
3. Review as if seeing this code for the first time:
   ...
   - Any improvements a reviewer might request? Consider any project-level instructions.
