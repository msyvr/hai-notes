---
name: review-notes
description: Search session notes for relevant context. Use when the user wants to review past session notes, find prior decisions, or search for context from previous work.
---
