---
name: move-current-session-notes
description: Move the entire current session file to a different project's session notes.
---
...
**Usage:**
- `/move-current-session-notes` — prompts for target project
- `/move-current-session-notes my-project` — moves to the specified project
